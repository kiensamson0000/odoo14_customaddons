            ...
            for data in list_products:
                if 'id' in data:
                    vals = {
                        ...
                        'weight': data['weight'],
                        'woo_height': float(data['dimensions']['height']),
                        'woo_length': float(data['dimensions']['length']),
                        'woo_width': float(data['dimensions']['width']),
                    ...
                    if data['manage_stock'] == True:
                        vals['woo_stock_quantity'] = int(data['stock_quantity'])
                    else:
                        vals['woo_manage_stock'] = False
