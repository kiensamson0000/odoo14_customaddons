...
class SendoSellerProduct(models.Model):
    ...
    special_price = fields.Float(string='Price', store=True)
        ...
        try:
            ...
            for product in list_products:
                if 'id' in product:
                    ...
                    val['special_price'] = product['special_price']
    ...
    def get_product_sendo_to_product_template(self):
        try:
            ...
            for product in list_products:
                if 'id' in product:
                    val['type'] = 'product'
                    val['categ_id'] = 'Test_Sendo'
                    val['name'] = product['name']
                    val['list_price'] = product['special_price']
                    # val['stock_quantity'] = product['stock_quantity']
                    ...
                    if len(existed_seller_product) < 1:
                        ...
                        existed_seller_product.env['product.template'].write(val)
